...
def create_app() -> FastAPI:
    ...
    # Get ThingServer's app - we'll add our custom routes to it
    ...
    # Note: ThingServer routes are at root level (e.g., /flow/, /heater/)
    # We'll add our custom routes at /api/ prefix
