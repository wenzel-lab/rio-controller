...
def register_routes(app: Flask, socketio: SocketIO, 
                   view_model, heaters: List[Any], flow, cam, debug_data: dict) -> None:
    """
...
def create_background_update_task(socketio: SocketIO, view_model, 
                                  heaters: List[Any], flow, cam, debug_data: dict):
    """
