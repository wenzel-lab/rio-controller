...
if os.path.exists(droplet_detection_path):
    ...
    from droplet_detection.measurer import Measurer, DropletMetrics
...
class TestMeasurementMethods(unittest.TestCase):
    ...
    def test_radius_offset_correction(self):
        ...
        self.assertAlmostEqual(
            actual_difference, expected_difference, places=1,
        ...
        self.assertLess(
            diameter_with_offset, diameter_no_offset,
    ...
    def test_radius_offset_positive(self):
        ...
        self.assertGreater(
            diameter_with_offset, diameter_no_offset,
            "Positive offset should increase diameter"
        )
    ...
    def test_negative_radius_protection(self):
        ...
        self.assertGreaterEqual(
            metrics[0].equivalent_diameter, 0.0,
    ...
    def test_area_preservation(self):
        ...
        self.assertEqual(
            metrics_no_offset[0].area, metrics_with_offset[0].area,
    ...
    def test_equivalent_diameter_formula(self):
        ...
        self.assertAlmostEqual(
            measured_diameter, expected_diameter, places=1,
