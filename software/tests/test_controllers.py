...
class TestFlowWeb(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from drivers.spi_handler import spi_init, PORT_FLOW  # noqa: E402
...
class TestHeaterWeb(unittest.TestCase):
    ...
    def test_get_temperature(self):
        ...
        # heater_web doesn't have get_temperature(), but has temp_c_actual
        # Call update() to refresh temperature
        self.heater.update()
        temp = self.heater.temp_c_actual
