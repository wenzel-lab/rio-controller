...
class SimulatedGPIO:
    ...
    @classmethod
    def setup(cls, channel: int, direction: int, initial: Optional[int] = None,
...
class SimulatedSPIHandler:
    ...
    def __init__(self, bus: int = DEFAULT_BUS, mode: int = DEFAULT_MODE,
                 speed_hz: int = DEFAULT_SPEED_HZ, pin_mode: Optional[int] = None):
        """
