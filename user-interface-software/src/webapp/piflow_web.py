...
try:
    from config import (
        FLOW_REPLY_PAUSE_S, FLOW_NUM_CONTROLLERS,
        CONTROL_MODE_FIRMWARE_TO_UI, CONTROL_MODE_UI_TO_FIRMWARE
    )
except ImportError:
...
class FlowWeb:
    ...
    def __init__(self, port: int) -> None:
        ...
        self.flow = piflow.PiFlow(port, FLOW_REPLY_PAUSE_S)
    ...
    def get_flow_targets(self) -> None:
        """
    ...
    def get_control_modes(self) -> None:
        """
    ...
    def get_flow_pi_consts(self) -> None:
        ...
        try:
            ...
            if valid:
                ...
                self.flow_pi_consts = [
                    [pid_consts[0], pid_consts[1]]
                    for pid_consts in flow_pid_consts
                ]
            else:
    ...
    def set_control_mode(self, index: int, control_mode: int) -> bool:
        ...
        try:
            ...
            if valid:
                self.get_control_modes()
                logger.debug(f"Control mode set for controller {index}: "
    ...
    def set_flow_pi_consts(self, index: int, pi_consts: List[int]) -> bool:
        ...
        try:
            ...
            if valid:
                self.get_flow_pi_consts()
                logger.debug(f"PI constants set for controller {index}: P={pi_consts[0]}, I={pi_consts[1]}")
            else:
    ...
    def update(self) -> None:
        ...
        try:
            ...
            # If connection restored, reload all state
