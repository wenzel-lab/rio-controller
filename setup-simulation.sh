...
cd "$REPO_ROOT/user-interface-software/src"
...
echo "  3. Run webapp: cd user-interface-software/src/webapp && python pi_webapp.py"
echo ""
echo "Or use the run-simulation.sh script for convenience."
echo ""
